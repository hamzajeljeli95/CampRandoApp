...
public class ProfileFragment extends Fragment {
    ...
    private TextView tv_name,tv_email,tv_id,tv_gender;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
      ...
      /* UserModel userModel = SharedPreferenceManager.getSharedInstance().getUserModelFromPreferences();
        tv_id.setText(userModel.userid);
        tv_name.setText(userModel.userName);
        tv_email.setText(userModel.userEmail);
        tv_gender.setText(userModel.gender);
        imageprofile.setImageURI(Uri.parse(userModel.profilePic))*/
