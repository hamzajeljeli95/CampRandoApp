package com.wassi.camprandoapp.managers;
...
public class SharedPreferenceManager {
    ...
    */
    ...
    public void saveUserModel(UserModel userModel)
    {
        ...
        setStringInPreferences(AppConstants.SharedPreferenceKeys.USER_TEL.getKey(), userModel.userTel);
    }
    ...
    public UserModel getUserModelFromPreferences()
    {
        ...
        if(!TextUtils.isEmpty(name)) {
            ...
            userModel.userid= getStringFromPreferances(AppConstants.SharedPreferenceKeys.USER_ID.getKey());
            ...
            //userModel.gender = getStringFromPreferances(AppConstants.SharedPreferenceKeys.USER_TEL.getKey());
        }
        return userModel;
    }
